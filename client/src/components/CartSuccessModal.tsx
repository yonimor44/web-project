...
export const CartSuccessModal = () => {
    ...
    const handleGoToCart = () => {
        handleClose();
        navigate('/cart'); // הולכים לדף העגלה המלא
    };
        ...
        >
            ...
            <DialogContent sx={{ textAlign: 'center', py: 3 }}>
                <Box 
                    ...
                    sx={{ width: 100, height: 70, objectFit: 'contain', mb: 2 }} 
                />
                <Typography variant="h6" fontWeight="bold">
                    {lastAddedItem.carMake} {lastAddedItem.name}
                </Typography>
            ...
            <DialogActions sx={{ flexDirection: 'column', gap: 1, px: 3, pb: 3 }}>
                ...
                <Button 
                    ...
                    size="large"
                    onClick={handleClose}
                    sx={{ ml: '0 !important' }} // ביטול המרווח הדיפולטי של MUI
                >
                    המשך בקניות
                </Button>
            </DialogActions>
